...
class OperatorChooseButton extends StatefulWidget {
  OperatorChooseButton({required this.operatorModel, required this.onTap});
  OperatorModel operatorModel;
  void Function() onTap;
  @override
  _OperatorChooseButtonState createState() => _OperatorChooseButtonState();
}

class _OperatorChooseButtonState extends State<OperatorChooseButton> {
  @override
          ...
          Material(
            ...
            child: InkWell(
              ...
              child: CircleAvatar(
                radius: 25,
                backgroundColor:
                    ((widget.operatorModel.color == Colors.white) &&
                ...
                child: Text(
                    ...
                    style: TextStyle(
                        color: widget.operatorModel.isActive
                            ? greenColor
                            : Colors.white,
